...
if("TRUE" STREQUAL "TRUE")
  set(plan_env_SOURCE_PREFIX /home/uav1/ego+ctrl/ego_planner/Fast-Drone-250/src/planner/plan_env)
  set(plan_env_DEVEL_PREFIX /home/uav1/ego+ctrl/ego_planner/Fast-Drone-250/devel)
  set(plan_env_INSTALL_PREFIX "")
  set(plan_env_PREFIX ${plan_env_DEVEL_PREFIX})
else()
  set(plan_env_SOURCE_PREFIX "")
  set(plan_env_DEVEL_PREFIX "")
  set(plan_env_INSTALL_PREFIX /home/uav1/ego+ctrl/ego_planner/Fast-Drone-250/install)
...
if(NOT "/home/uav1/ego+ctrl/ego_planner/Fast-Drone-250/src/planner/plan_env/include;/usr/include;/usr/include/opencv " STREQUAL " ")
  set(plan_env_INCLUDE_DIRS "")
  set(_include_dirs "/home/uav1/ego+ctrl/ego_planner/Fast-Drone-250/src/planner/plan_env/include;/usr/include;/usr/include/opencv")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'plan_env' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/uav1/ego+ctrl/ego_planner/Fast-Drone-250/src/planner/plan_env/${idir}'.  ${_report}")
    endif()
